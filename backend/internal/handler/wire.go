...
func ProvideAdminHandlers(
	...
	requestRecordHandler *requestrecord.AdminHandler,
...
func ProvideGatewayHandler(
	...
	h := NewGatewayHandler(gatewayService, openAIGatewayService, geminiCompatService, antigravityGatewayService,
		...
		errorPassthroughService, contentModerationService, userMsgQueueService, requestRecordService, cfg, settingService)
...
func ProvideOpenAIGatewayHandler(
	...
	h := NewOpenAIGatewayHandler(gatewayService, concurrencyService, billingCacheService, apiKeyService,
		usageRecordWorkerPool, errorPassthroughService, contentModerationService, requestRecordService, opsService, cfg)
	h.securityAuditCoordinator = coordinator
	return h
}
