<template>
  <button
    type="button"
    class="cch-panel-card group flex min-h-[280px] w-full flex-col p-5 text-left transition-all duration-300 ease-out hover:-translate-y-0.5 hover:border-primary-200 hover:shadow-md dark:hover:border-primary-500/30"
    @click="emit('click')"
  >
