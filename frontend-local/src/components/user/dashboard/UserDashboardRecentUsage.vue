  ...
  <div class="cch-panel-card">
    ...
    <div class="p-6">
      ...
      <div v-else class="space-y-3">
        <div v-for="log in data" :key="log.id" class="flex items-center justify-between rounded-md p-3 transition-colors hover:bg-gray-100/80 dark:hover:bg-white/[0.04]">
