<template>
  <div class="cch-panel-card">
    ...
    <div class="space-y-3 p-4">
      <button @click="router.push('/keys')" class="group flex w-full items-center gap-4 rounded-md p-3 text-left transition-all duration-200 hover:bg-gray-100/80 dark:hover:bg-white/[0.04]">
      ...
      <button @click="router.push('/usage')" class="group flex w-full items-center gap-4 rounded-md p-3 text-left transition-all duration-200 hover:bg-gray-100/80 dark:hover:bg-white/[0.04]">
      ...
      <button v-if="canUseBatchImage" @click="router.push('/batch-image')" class="group flex w-full items-center gap-4 rounded-md p-3 text-left transition-all duration-200 hover:bg-gray-100/80 dark:hover:bg-white/[0.04]">
      ...
      <button @click="router.push('/redeem')" class="group flex w-full items-center gap-4 rounded-md p-3 text-left transition-all duration-200 hover:bg-gray-100/80 dark:hover:bg-white/[0.04]">
