<template>
  <div v-if="visible" data-test="cn-provider-quota" class="min-w-[220px] space-y-1">
    <div v-if="data?.success && data.tiers?.length" class="space-y-1">
      ...
      >
        <span data-test="cn-provider-quota-label" class="w-14 shrink-0 whitespace-nowrap text-gray-500 dark:text-gray-400">
        ...
        <span v-if="tier.reset_at" class="min-w-0 truncate text-gray-400 dark:text-gray-500" :title="tier.reset_at">
