<template>
  ...
  >
    ...
    >
      ...
      <!-- Zhipu team Coding Plan identifiers -->
      ...
      >
        ...
        <div v-if="isHeaderOverrideCapable(form.platform, 'oauth')" class="space-y-3">
          <div class="flex items-center justify-between">
            <div>
              <label class="input-label mb-0">{{ t('admin.accounts.headerOverride.title') }}</label>
      ...
      <!-- OpenAI API 长上下文计费，WebSocket 模式保持独立。 -->
      <div
        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div class="flex w-full flex-col gap-2 sm:w-72">
            <Select
              ...
              data-testid="create-openai-first-output-timeout-mode"
            ...
            <input
              ...
              step="1"
              class="input"
              data-testid="create-openai-first-output-timeout-seconds"
...
const buildOpenAIExtra = (base?: Record<string, unknown>): Record<string, unknown> | undefined => {
  ...
  if (openAIFirstOutputTimeoutMode.value === 'custom') {
    ...
    extra.openai_first_output_timeout_seconds = 0
  } else {
    delete extra.openai_first_output_timeout_seconds
  }
