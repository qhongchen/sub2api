<template>
  ...
  >
    <table class="cch-data-table w-full min-w-max divide-y divide-gray-200/70 dark:divide-white/[0.08]">
      ...
      <tbody class="table-body divide-y divide-gray-100/80 bg-white/50 dark:divide-white/[0.06] dark:bg-transparent">
        <!-- Loading skeleton -->
...
<style scoped>
.cch-mobile-table-list {
  @apply space-y-3;
}

.cch-mobile-table-card {
  @apply rounded-2xl border border-gray-200/60 bg-white/70 p-4 shadow-sm backdrop-blur-lg;
...
tbody tr:hover .sticky-col {
  background-color: rgb(255 247 237 / 0.88);
}

.dark tbody tr:hover .sticky-col {
  background-color: rgb(30 41 59 / 0.94);
}
