<template>
  <div class="cch-panel-card p-4 md:p-5">
    <div class="mb-4 flex items-center justify-between gap-3">
      ...
      <div class="flex flex-wrap items-center justify-end gap-2">
        ...
        <div v-if="enableRankingView" class="cch-segmented">
          <button
            type="button"
            class="cch-segmented-button"
            :class="
    ...
    <div
      ...
      class="flex flex-col items-center gap-6 xl:flex-row"
    >
      <div class="h-48 w-48">
        <Doughnut :data="chartData" :options="doughnutOptions" />
      </div>
      <div class="max-h-48 w-full flex-1 overflow-auto">
    ...
    <div v-else-if="rankingDisplayItems.length > 0 && rankingChartData" class="flex flex-col items-center gap-6 xl:flex-row">
      <div class="h-48 w-48">
