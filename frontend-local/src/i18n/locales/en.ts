export default {
  ...
  nav: {
    ...
    usersAndGroups: 'Users & Access',
    channelsAndAccounts: 'Channels & Accounts',
    operationsAndBilling: 'Operations & Billing',
  ...
  keys: {
    ...
    bulkEdit: {
      ...
      hint: 'Enable the fields to change. Unchecked fields stay unchanged.',
      limitHint: 'Enter 0 for unlimited. Used quota is left unchanged.',
      ipHint: 'One IP or CIDR per line. Leave empty to clear that list on the selected keys.',
      invalidLimit: 'Enter a valid amount greater than or equal to 0.',
      invalidExpiration: 'Choose a valid expiration time, or mark the key as never expiring.',
      apply: 'Apply to {count} keys',
      success: 'Updated {count} keys',
      partialFailure: 'Updated {success} keys, {failed} failed',
      failureHint: 'These keys failed to update. Change the settings and retry. A retry only updates the failed keys.'
    },
  ...
  usage: {
    ...
    activeSessions: 'Recent Requests',
    activeSessionsSummary: '{count} requests in {minutes} minutes',
    viewAll: 'View all',
    noActiveSessions: 'No requests in the last 5 minutes',
    ...
    timeRangeDescription: 'Filter by date',
    startDate: 'Start Date',
    endDate: 'End Date',
    identityInfo: 'Identity',
    identityDescription: 'Filter by key and model',
    adminIdentityDescription: 'Filter by user and API key',
    requestParams: 'Request Parameters',
    requestDescription: 'Filter by type and endpoint',
    adminRequestDescription: 'Filter by account, model, and billing criteria',
    statusInfo: 'Status',
    statusDescription: 'Filter by status and retries',
    statusFilterUnavailable: 'Status filtering is not supported by the current API',
    endpointFilterUnavailable: 'Endpoint filtering is not supported by the current API',
    modelPlaceholder: 'Enter model name',
    allTypes: 'All types',
    compactionFilter: 'Request Kind',
    allCompactionTypes: 'All request kinds',
    compactionOnly: 'Native compaction',
    ...
    upstreamAttemptCount: '{count} upstream attempts',
    upstreamAttemptStatus: 'upstream {status}',
  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        reasoningEffortMappingsHint: 'Leave type and model empty to match all models, or use exact, prefix, or suffix matching. Request value none matches explicit none, not omitted effort; forwarded value Deny rejects the request. Exact matches beat affixes, and longer affixes beat shorter ones.',
        addReasoningEffortMapping: 'Add mapping',
        removeReasoningEffortMapping: 'Remove mapping',
        removeReasoningEffortPair: 'Remove mapping pair',
        addReasoningEffortPair: 'Add pair',
        ...
        reasoningEffortModelPlaceholder: 'Optional model name or prefix/suffix',
      ...
      codexModelsManifest: {
        ...
        hint: 'When enabled, ordinary model lists and Codex Model Manifest are discovered from the pinned accounts first, then merged and filtered using account mappings and the group model allowlist. Rate-limited or overloaded pinned accounts are still used.',
        ...
        maxAccounts: 'Select at most 10 accounts'
      },
    ...
    riskControl: {
      ...
      engineUnavailable: 'The current engine has no available keys, so API audit is unavailable. Failed requests follow the existing allow policy.',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        intervalSecondsHint: 'Enter a positive whole number of seconds',
        jitterSeconds: 'Random Jitter (± seconds)',
        jitterSecondsHint: 'Each check fires at interval ± a random offset within this value; 0 means fixed interval. Jitter must be less than the interval',
    ...
    accounts: {
      ...
      status: {
        ...
        modelLimitedCount: '{count} model limits',
        modelLimitedDetail: '{count} models are currently rate limited',
      ...
      openai: {
        ...
        firstOutputTimeout: 'First-output timeout (per account)',
        firstOutputTimeoutDesc:
          'Applies to OpenAI streaming requests. Inherit the global setting, set 30-1800 seconds for this account, or disable the account timeout.',
        firstOutputTimeoutInherit: 'Inherit global setting',
        firstOutputTimeoutCustom: 'Custom timeout',
        firstOutputTimeoutDisabled: 'Disable timeout',
        firstOutputTimeoutSecondsPlaceholder: 'Seconds (30-1800)',
        firstOutputTimeoutInvalid: 'First-output timeout must be an integer from 30 to 1800 seconds',
      ...
      expiresInOneMonth: 'In one month',
      expiresInOneYear: 'In one year',
    ...
    usage: {
      ...
      activeConversationsSummary: '{count} active sessions',
    ...
    requestLogs: {
      title: 'Request Logs',
      description: 'View successful and failed request streams for troubleshooting request sources',
      filters: 'Filters',
      timeRange: 'Time Range',
      status: 'Status',
      ...
      allTypes: 'All Types',
      allGroups: 'All Groups',
      excludeStatus200: 'Exclude 200',
      customStatusCode: 'Custom Status Code',
      sortNewest: 'Newest First',
      sortDuration: 'Duration Desc',
      apply: 'Apply',
      reset: 'Reset',
      refresh: 'Refresh',
      tableTitle: 'Request Details',
      columnSettings: 'Column Settings',
      resetColumns: 'Reset Columns',
      visibleColumnsSummary: 'Showing {visible}/{total} columns',
      searchUserPlaceholder: 'Search users by email...',
      searchApiKeyPlaceholder: 'Search API keys by name...',
      searchAccountPlaceholder: 'Search accounts by name...',
      modelPlaceholder: 'Enter model name, e.g. 5.4-mini',
      requestIdPlaceholder: 'Enter full Request ID',
      sessionIdPlaceholder: 'Enter full Session ID',
      selected: 'Selected',
      filterGroups: {
        time: 'Time Range',
        timeDescription: 'Control the request-record query window',
        identity: 'Identity & Source',
        identityDescription: 'Locate sources by user, key, account, and group',
        routing: 'Request & Routing',
        routingDescription: 'Trace by model, Request ID, and Session',
        result: 'Status & Result',
        resultDescription: 'Filter by status code and sort'
      },
      totalRequests: 'Total Requests',
      successRequests: 'Successful Requests',
      errorRequests: 'Failed Requests',
      errorRate: 'Failure Rate',
      kindSuccess: 'Success',
      kindError: 'Error',
      noValue: '-',
      empty: 'No request records',
      emptyHint: 'Try expanding the time range or removing filters.',
      loading: 'Loading request records...',
      loadedRecordsSummary: 'Loaded {count} / {total} records',
      scrollLoadMore: 'Scroll to the bottom to load more',
      loadingMore: 'Loading more...',
      allRecordsLoaded: 'All records loaded',
      loadFailed: 'Failed to load request records',
      disabledTitle: 'Ops monitoring is disabled',
      disabledDescription: 'Request logs depend on ops monitoring data. Enable ops monitoring in system settings first.',
      ...
      diagnostics: {
        ...
        filterSession: 'Filter by this Session',
        retryRecovered: 'Upstream failed mid-flight, final response recovered',
        pendingHint: 'Request is still running',
        summaryPending: 'This record is still pending; only recorded input, identity, routing, and session facts are available.',
        summaryRecovered: 'The final client response succeeded. Failed upstream attempts below indicate retry or account switching recovered the request.',
        summarySuccess: 'The request was returned successfully to the client. Review identity, routing, performance, resource, and billing facts below.',
        summaryError: 'The final client response failed. Use the final error and upstream attempts below to locate the failing layer.',
        finalError: 'Final error',
        overview: 'Overview',
        identity: 'Identity & Source',
        routing: 'Routing & Model',
        session: 'Session Linkage',
        resourceBilling: 'Resources & Billing',
        upstreamTimeline: 'Upstream Attempts Timeline',
        ...
        upstreamModelConsistency: 'Response model consistency',
        consistencyUnobserved: 'Not observed',
        ...
        rateMultiplier: 'User multiplier',
        accountRateMultiplier: 'Account multiplier',
        nonBillableNote: 'This is a non-billable request: resource facts remain useful for diagnostics, but cost is not counted in user or account statistics.',
        billableCostPendingNote: 'This request is marked billable but cost fields are not populated yet, usually because the record is still being completed or the backend did not return pricing fields.',
        upstreamRequestId: 'Upstream Request ID',
        upstreamUrl: 'Upstream URL',
        noUpstreamAttempts: 'No upstream attempt details are available. If the final status is abnormal, start with the final error and request source.',
        yes: 'Yes',
        no: 'No'
      },
      table: {
    ...
    ops: {
      ...
      errorLog: {
        ...
        payloads: {
          client: 'Client Error Body',
          upstream_message: 'Upstream Error Message',
          upstream_detail: 'Upstream Error Detail',
          upstream_events: 'Upstream Error List'
        },
      ...
      settings: {
        ...
        emailPlaceholder: 'Enter email address',
        recipientsHint: 'Configure at least one recipient before sending notifications',
        minSeverity: 'Minimum Severity',
        reportConfig: 'Report Configuration',
        channelStatusConfig: 'Channel Status Notification',
        channelStatusHint: 'Send email notification when a channel transitions between success and failure states after consecutive occurrences',
        enableChannelStatus: 'Enable Channel Status Notification',
        channelStatusRecipients: 'Channel Status Notification Recipient Emails',
        consecutiveThreshold: 'Consecutive Threshold',
        consecutiveThresholdHint: 'Number of consecutive same-state results required before a transition triggers notification (default: 5)',
        channelStatusTest: 'Send Test',
        channelStatusTestSending: 'Sending...',
        channelStatusTestHint: 'Sending a test saves the current email notification configuration first',
        channelStatusTestSent: 'Channel status test email sent',
        channelStatusTestFailed: 'Failed to send channel status test email',
        channelStatusTestRecipientsRequired: 'Add at least one channel status notification recipient first',
    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          defaultIntervalHint: 'V1 only: default interval for new monitors (overridable per monitor). Enter a positive whole number of seconds.',
      ...
      gatewayForwarding: {
        ...
        openaiTTFTModeHint: 'Records first_token_ms at the first semantic event, or waits for visible text, tool arguments, or image content.',
  ...
  payment: {
    ...
    orders: {
      title: 'My Orders',
      description: 'View recharge and subscription orders, including pending payments, refunds, and status tracking.',
      empty: 'No orders yet',
      orderId: 'Order ID',
      orderNo: 'Order No.',
      amount: 'Amount',
    ...
    currentBalance: 'Current Balance',
    purchaseDescription: 'A focused entry for balance top-up, subscription checkout, and payment follow-up.',
    ...
    admin: {
      ...
      revenueTrendDesc: 'Track revenue and order count by day',
      ...
      ordersPageDesc: 'Filter, inspect, and operate recharge/subscription orders, including cancel, retry, and refund flows.',
      daySuffix: 'd',
