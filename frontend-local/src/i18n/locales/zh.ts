export default {
  ...
  nav: {
    ...
    riskControl: '风控中心',
    systemOverview: '系统概览',
    usersAndGroups: '用户与权限',
    channelsAndAccounts: '渠道与账号',
    operationsAndBilling: '运营与计费',
  ...
  keys: {
    ...
    providerHints: {
      ...
      domestic: '包含 DeepSeek、Kimi、智谱 GLM',
  ...
  usage: {
    ...
    activeSessions: '近期请求',
    activeSessionsSummary: '近 {minutes} 分钟 {count} 条请求',
    viewAll: '查看全部',
    noActiveSessions: '近 5 分钟暂无请求',
    filterCriteria: '筛选条件',
    columnSettings: '列设置',
    autoRefresh: '自动刷新',
    quickToday: '今天',
    quickThisWeek: '本周',
    quickLast7Days: '近 7 天',
    quickLast30Days: '近 30 天',
    timeRangeDescription: '按日期筛选',
    startDate: '开始日期',
    endDate: '结束日期',
    identityInfo: '身份信息',
    identityDescription: '按密钥和模型筛选',
    adminIdentityDescription: '按用户、API 密钥筛选',
    requestParams: '请求参数',
    requestDescription: '按类型、端点筛选',
    adminRequestDescription: '按账号、模型和计费条件筛选',
    statusInfo: '状态信息',
    statusDescription: '按状态和重试次数筛选',
    statusFilterUnavailable: '当前接口暂不支持状态筛选',
    endpointFilterUnavailable: '当前接口暂不支持端点筛选',
    modelPlaceholder: '输入模型名称',
    allTypes: '全部类型',
    compactionFilter: '请求类别',
    allCompactionTypes: '全部请求类别',
    compactionOnly: '原生压缩',
    ...
    upstreamAttemptCount: '{count} 次上游尝试',
    upstreamAttemptStatus: '上游 {status}',
    viewDiagnostics: '诊断详情',
    billable: '计费',
    nonBillable: '非计费',
    costDetails: '成本明细',
  ...
  admin: {
    ...
    dashboard: {
      ...
      rangeThisMonth: '本月',
      metricAmount: '消费金额',
      metricApiCalls: 'API 调用次数',
      metricTokenCount: 'Token 数量',
      userRanking: '用户排行',
      accountRanking: '账号排行',
      modelRanking: '模型排行',
    ...
    groups: {
      ...
      form: {
        ...
        reasoningEffortMatchTypePlaceholder: '全部模型',
      ...
      copyAccounts: {
        title: '从分组复制账号',
        tooltip: '选择一个或多个符合条件的分组。普通分组只能从相同平台复制，Composite 分组可从任意受支持平台复制；创建后账号会绑定到新分组并自动去重。',
        tooltipEdit: '选择一个或多个符合条件的分组。普通分组只能从相同平台复制，Composite 分组可从任意受支持平台复制；保存后会替换当前绑定并自动去重。',
    ...
    channelMonitor: {
      ...
      form: {
        ...
        intervalSecondsHint: '请输入正整数秒',
        jitterSeconds: '随机抖动 (± 秒)',
        jitterSecondsHint: '每次检测在间隔基础上正负随机偏移该秒数，0 表示固定间隔；抖动必须小于间隔',
        enabled: '启用监控',
        kindRequired: '请选择供应商'
      },
      runResultTitle: '检测结果',
    ...
    subscriptions: {
      ...
      guide: {
        ...
        actions: {
          ...
          revoke: '撤销',
          revokeDesc: '立即终止该用户的订阅，可稍后从已撤销列表恢复'
        },
    ...
    accounts: {
      ...
      status: {
        ...
        modelLimitedCount: '{count} 个模型限流',
        modelLimitedDetail: '{count} 个模型处于限流状态',
      ...
      openai: {
        ...
        firstOutputTimeout: '首输出超时（账号级）',
        firstOutputTimeoutDesc: '仅影响 OpenAI 流式请求。继承全局配置，或为此账号设置 30-1800 秒；禁用会关闭该账号的首输出超时。',
        firstOutputTimeoutInherit: '继承全局配置',
        firstOutputTimeoutCustom: '自定义超时',
        firstOutputTimeoutDisabled: '禁用超时',
        firstOutputTimeoutSecondsPlaceholder: '输入秒数（30-1800）',
        firstOutputTimeoutInvalid: '首输出超时必须是 30-1800 秒的整数',
      ...
      headerOverride: {
        ...
        info: '配置值会在转发前替换客户端或网关生成的同名头。认证头、连接控制头、WebSocket 头和会话隔离头不允许覆写。',
    ...
    requestLogs: {
      title: '请求记录',
      description: '查看成功与失败请求流水，用于排查异常请求来源',
      filters: '筛选条件',
      timeRange: '时间范围',
      status: '状态',
      statusCode: '状态码',
      ...
      allTypes: '全部类型',
      allGroups: '全部分组',
      excludeStatus200: '排除 200',
      customStatusCode: '自定义状态码',
      sortNewest: '按时间倒序',
      sortDuration: '按耗时倒序',
      apply: '应用筛选',
      reset: '重置',
      ...
      columnSettings: '列设置',
      resetColumns: '恢复默认列',
      visibleColumnsSummary: '当前显示 {visible}/{total} 列',
      searchUserPlaceholder: '按邮箱搜索用户...',
      searchApiKeyPlaceholder: '按名称搜索 API Key...',
      searchAccountPlaceholder: '按名称搜索账号...',
      modelPlaceholder: '输入模型名，如 5.4-mini',
      requestIdPlaceholder: '输入完整 Request ID',
      sessionIdPlaceholder: '输入完整 Session ID',
      selected: '已选择',
      filterGroups: {
        time: '时间范围',
        timeDescription: '控制请求记录的查询窗口',
        identity: '身份与来源',
        identityDescription: '按用户、密钥、账号和分组定位来源',
        routing: '请求与路由',
        routingDescription: '按模型、Request ID 和 Session 定位链路',
        result: '状态与结果',
        resultDescription: '按状态码和排序筛选'
      },
      totalRequests: '总请求',
      ...
      noValue: '-',
      empty: '暂无请求记录',
      emptyHint: '可尝试扩大时间范围或取消部分筛选。',
      loading: '正在加载请求记录...',
      loadedRecordsSummary: '已加载 {count} / {total} 条记录',
      scrollLoadMore: '下拉到底部加载更多',
      loadingMore: '正在加载更多...',
      allRecordsLoaded: '已加载全部记录',
      loadFailed: '加载请求记录失败',
      disabledTitle: '运维监控未启用',
      disabledDescription: '请求记录依赖运维监控数据。请先到系统设置开启运维监控。',
      openSettings: '前往系统设置',
      ...
      diagnostics: {
        ...
        filterSession: '按此 Session 筛选',
        retryRecovered: '中途上游失败，最终已恢复',
        pendingHint: '请求仍在进行中',
        summaryPending: '当前记录还未完成，只能看到已写入的入参、身份、路由和会话信息。',
        summaryRecovered: '最终返回客户端的是成功状态；上游尝试中存在失败项，说明请求经过重试或切换后恢复。',
        summarySuccess: '最终已成功返回客户端，可在下方核对身份、路由、性能、资源和计费信息。',
        summaryError: '最终返回客户端的是失败状态；下方错误摘要和上游尝试可辅助定位失败发生在哪一层。',
        finalError: '最终错误',
        overview: '概要',
        identity: '身份与来源',
        routing: '路由与模型',
        session: 'Session 关联',
        resourceBilling: '资源与计费',
        upstreamTimeline: '上游尝试 Timeline',
        finalOutcome: '最终结果',
        ...
        upstreamModelConsistency: '响应模型一致性',
        consistencyUnobserved: '未观测',
        modelConsistent: '一致',
        modelMismatch: '不一致',
      ...
      requestedReasoningEffort: '请求推理强度',
        ...
        inboundEndpoint: '入口',
        upstreamEndpoint: '上游入口',
        modelMappingChain: '模型映射链',
        sessionId: 'Session ID',
        sessionSource: 'Session 来源',
        ...
        nonBillableNote: '这是非计费请求：资源信息可用于诊断，但费用不会计入用户或账号统计。',
        billableCostPendingNote: '该请求标记为计费，但费用字段暂未写入，通常表示记录还在补全或后端未返回价格字段。',
        upstreamRequestId: '上游 Request ID',
        upstreamUrl: '上游地址',
        noUpstreamAttempts: '暂无上游尝试明细。若最终状态异常，可先查看最终错误和请求来源。',
        yes: '是',
        no: '否'
      },
      table: {
    ...
    ops: {
      ...
      errorDetail: {
        ...
        payloads: {
          client: '客户端错误体',
          upstream_message: '上游错误消息',
          upstream_detail: '上游错误详情',
          upstream_events: '上游错误列表'
        },
        basicInfo: '基本信息',
        platform: '平台',
        model: '模型',
      ...
      settings: {
        ...
        emailPlaceholder: '输入邮箱地址',
        recipientsHint: '请至少配置一个收件人后再发送通知',
        minSeverity: '最低级别',
        reportConfig: '评估报告配置',
        channelStatusConfig: '渠道状态通知',
        channelStatusHint: '当渠道连续多次成功后转为失败，或连续多次失败后转为成功时，发送邮件通知',
        enableChannelStatus: '开启渠道状态通知',
        channelStatusRecipients: '渠道状态通知接收邮箱',
        consecutiveThreshold: '连续次数阈值',
        consecutiveThresholdHint: '连续达到此次数后状态翻转才触发通知（默认：5）',
        channelStatusTest: '测试发送',
        channelStatusTestSending: '发送中...',
        channelStatusTestHint: '测试发送会先保存当前的邮件通知配置',
        channelStatusTestSent: '渠道状态测试邮件已发送',
        channelStatusTestFailed: '渠道状态测试邮件发送失败',
        channelStatusTestRecipientsRequired: '请先添加至少一个渠道状态通知接收邮箱',
        enableReport: '开启评估报告',
    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          defaultIntervalHint: '仅 V1 模式使用：新建渠道监控时表单的默认值，可被单个渠道覆盖。请输入正整数秒。',
      ...
      gatewayForwarding: {
        ...
        openaiTTFTModeHint: '历史兼容口径在首个语义事件记录 first_token_ms；真实可见输出仅在文本、工具参数或图片内容到达时记录。',
        title: '请求转发行为',
  ...
  payment: {
    ...
    orders: {
      title: '我的订单',
      description: '查看充值与订阅订单，处理待支付、退款申请和订单状态追踪。',
      empty: '暂无订单',
      orderId: '订单 ID',
      orderNo: '订单编号',
      amount: '金额',
    ...
    currentBalance: '当前余额',
    purchaseDescription: '用一个轻量入口完成余额充值、套餐订阅和支付后续追踪。',
    availableMethods: '可用支付方式',
    ...
    admin: {
      ...
      revenue: '收入',
      dailyRevenue: '每日收入',
      revenueTrendDesc: '按日期查看收入与订单数变化',
      ...
      ordersPageDesc: '筛选、查看和处理充值/订阅订单，覆盖取消、重试与退款流程。',
      daySuffix: '天',
