  ...
  <AppLayout>
    <div class="mx-auto max-w-5xl space-y-6">
      ...
      <div class="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        ...
        <div class="cch-panel-card overflow-hidden">
          <div class="flex h-full min-h-[260px] flex-col justify-center bg-gradient-to-br from-primary-500 to-primary-600 px-6 py-8 text-center">
            <div
              class="mb-4 inline-flex h-16 w-16 items-center justify-center self-center rounded-2xl bg-white/20 backdrop-blur-sm"
            >
      ...
      <transition name="fade">
        <div
          v-if="redeemResult"
          class="cch-panel-card border-emerald-200 bg-emerald-50 dark:border-emerald-800/50 dark:bg-emerald-900/20"
        >
          <div class="p-6">
      ...
      <transition name="fade">
        <div
          v-if="errorMessage"
          class="cch-panel-card border-red-200 bg-red-50 dark:border-red-800/50 dark:bg-red-900/20"
        >
          <div class="p-6">
            <div class="flex items-start gap-4">
              <div
      ...
      <!-- Information Card -->
      <div
        class="cch-panel-card border-primary-200 bg-primary-50 dark:border-primary-800/50 dark:bg-primary-900/20"
      >
        <div class="p-6">
          <div class="flex items-start gap-4">
            <div
