<template>
  <AppLayout>
    <div class="mx-auto max-w-5xl space-y-6">
      ...
      <template v-else>
        <section v-if="paymentPhase === 'select'" class="cch-panel-card overflow-hidden">
            ...
            <div class="min-w-0 space-y-2">
              <div class="flex flex-wrap items-center gap-2">
                ...
                <span class="rounded-full border border-gray-200 bg-white px-2.5 py-1 text-xs font-medium text-gray-500 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-300">
                  {{ enabledMethods.length }} {{ t('payment.availableMethods') }}
                </span>
                <span
                ...
                >
                  {{ activeSubscriptions.length }} {{ t('payment.activeSubscriptionCount') }}
                </span>
              </div>
              <p class="max-w-2xl text-sm text-gray-500 dark:text-dark-300">
                {{ t('payment.purchaseDescription') }}
              </p>
            </div>
        ...
        <div v-if="tabs.length > 1 && paymentPhase === 'select' && !selectedPlan" class="cch-segmented w-full sm:w-auto">
          <button v-for="tab in tabs" :key="tab.key"
            class="cch-segmented-button flex-1 sm:flex-none"
            :class="activeTab === tab.key ? 'cch-segmented-button-active' : 'cch-segmented-button-muted'"
        ...
        <template v-else>
          ...
          <template v-if="activeTab === 'recharge'">
            ...
            <div v-if="enabledMethods.length === 0" class="cch-panel-card py-16 text-center">
              <p class="text-gray-500 dark:text-gray-400">{{ t('payment.notAvailable') }}</p>
            </div>
            <template v-else>
            <div class="cch-panel-card p-6">
              <AmountInput
                v-model="amount"
            ...
            <div v-if="enabledMethods.length >= 1" class="cch-panel-card p-6">
            ...
            <div v-if="validAmount > 0" class="cch-panel-card p-6">
          ...
          <template v-else-if="activeTab === 'subscription'">
            ...
            <template v-if="selectedPlan">
              ...
              <div v-if="feeRate > 0 && selectedPlan.price > 0" class="cch-panel-card p-6">
                <div class="space-y-2 text-sm">
                  <div class="flex justify-between">
            ...
            <!-- Plan list -->
            <template v-else>
              <div v-if="checkout.plans.length === 0" class="cch-panel-card py-16 text-center">
                  ...
                  <div v-for="sub in activeSubscriptions" :key="sub.id"
                    ...
                    <div class="min-w-0 flex-1">
                      ...
                      <div class="flex flex-wrap gap-x-3 text-[11px] text-gray-400 dark:text-gray-500">
                        ...
                        <span v-if="subscriptionHasPeakRate(sub)" class="text-amber-700 dark:text-amber-300">
        ...
        <div v-if="(checkout.help_text || checkout.help_image_url) && paymentPhase === 'select' && !selectedPlan" class="cch-panel-card p-4">
...
import { planValiditySuffix as formatPlanValiditySuffix } from '@/components/payment/validity'
...
const planValiditySuffix = computed(() => {
  ...
  return formatPlanValiditySuffix(selectedPlan.value, t)
})
