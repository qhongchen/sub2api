          ...
          <div class="cch-panel-card p-5">
            ...
            <div v-else class="space-y-2">
              <div v-for="[currency, users] in sortedTopUsers(stats.top_users)" :key="currency" class="space-y-2">
                ...
                <div v-for="(user, idx) in users" :key="user.user_id" class="flex items-center justify-between rounded-xl border border-gray-100 bg-gray-50/70 px-3 py-2.5 transition-colors hover:border-primary-100 hover:bg-primary-50/40 dark:border-white/[0.06] dark:bg-white/[0.03] dark:hover:border-primary-500/20 dark:hover:bg-primary-500/10">
