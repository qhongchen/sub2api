          ...
          <div class="min-w-0 space-y-2">
            <div class="flex flex-wrap items-center gap-2">
              ...
              <span class="rounded-full border border-gray-200 bg-white px-2.5 py-1 text-xs font-medium text-gray-500 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-300">
                {{ orderPagination.total }} {{ t('common.total') }}
              </span>
              <span class="rounded-full border border-gray-200 bg-white px-2.5 py-1 text-xs font-medium text-gray-500 dark:border-dark-700 dark:bg-dark-800 dark:text-dark-300">
                {{ orders.length }} {{ t('common.visible') }}
              </span>
              <span
              ...
              >
                {{ activeOrderFilterCount }} {{ t('common.filter') }}
              </span>
            </div>
            <p class="max-w-2xl text-sm text-gray-500 dark:text-dark-300">
              {{ t('payment.admin.ordersPageDesc') }}
            </p>
          </div>
      ...
      <div class="cch-toolbar-card">
        <div class="flex flex-wrap items-center gap-3">
          <div class="relative flex-1 sm:max-w-64">
            ...
            />
            <input v-model="orderSearch" type="text" :placeholder="t('payment.admin.searchOrders')" class="input pl-10" @input="debounceLoadOrders" />
          </div>
...
const activeOrderFilterCount = computed(() =>
  [orderSearch.value, orderFilters.status, orderFilters.payment_type, orderFilters.order_type]
